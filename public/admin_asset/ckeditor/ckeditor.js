...
(function () {
    ...
    (function () {
        var a = [], e = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, d = /</g, f = /"/g, h = /&amp;/g, n = /&gt;/g, i = /&lt;/g, k = /&quot;/g;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, d) {
                ...
                table: 1,
                ul: 1
            }, f = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, n = {"#": 1},
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var o = this.$.getBoundingClientRect(), s = e.$.documentElement,
                        q = s.clientTop || i.$.clientTop || 0, u = s.clientLeft || i.$.clientLeft || 0, g = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var f = c.startOffset, e = c.endOffset, o, j = this.guard, l = this.type,
        ...
        CKEDITOR.dom.range.prototype =
            {
                ...
                getBoundaryNodes: function () {
                    ...
                    if (!this.collapsed) {
                        var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), g = this.startContainer,
                            f = this.endContainer, e = this.startOffset, h = this.endOffset, m = 1, j = 1;
                ...
                setEndAt: function (a, b) {
                    ...
                    var b = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                        c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, g = c.block,
                        f = null;
                ...
                getPreviousNode: function (a, b, c) {
                    ...
                    var c = new CKEDITOR.dom.range(this.root), d = 0, g,
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var g = this, f = [], e = this.editor && this.editor.config.protectedSource, j, m = false,
        ...
        var y = {styles: 1, attributes: 1, classes: 1}, B = {
            ...
            N = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, M = /^cke:(object|embed|param)$/,
            D = /^(object|embed|param)$/, ba = CKEDITOR.filter.transformationsTools = {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (f, h, n) {
                ...
                var g = new CKEDITOR.htmlParser,
                    ...
                    z = [], A = [], m = p, j = p.name == "textarea", l = p.name == "pre";
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    f = Array.prototype.slice.call(arguments, 1), e = this.rules, n = e.length, i, k, o, s;
                for (s = 0; s < n; s++) {
                    if (d) {
                        i = c.type;
                        k = c.name
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                var a = a.data, c = a.dataValue, c = p(c, b), c = o(c, F), c = k(c), c = o(c, J),
                    c = c.replace(x, "$1cke:$2"), c = c.replace(B, "<cke:$1$2></cke:$1>"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        var z = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", m = CKEDITOR.dtd,
            j = ["caption", "colgroup", "col", "thead", "tfoot",
                "tbody"], l = CKEDITOR.tools.extend({}, m.$blockLimit, m.$block),
            v = {elements: {input: n, textarea: n}},
            P = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, r = {
                elements: {
                    embed: function (a) {
                        var b = a.parent;
                        if (b && b.name == "object") {
        ...
        var H = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            F = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, t = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            x = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            y = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, B = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var i = this.container, k = this.ui.space("contents"),
                ...
                changeAttr: function (a, b) {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in m) {
                                var b = a.getSelection(), e, r = b.getRanges()[0], h = r.startPath(), i, k, p,
                                    c = c == 8;
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                var b = d.document, c = CKEDITOR.document, g = d.editable(), j = b.getBody(),
                    m = b.getDocumentElement(), h = g.isInline(), i, o;
    ...
    (function () {
        ...
        function q(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = j(this)[a.getName()],
                f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), h;
        ...
        var P = {
            ...
            }, r =
                {
                    ...
                    audio: 1,
                    video: 1
                }, L = /\s*(?:;\s*|$)/, H = /#\((.+?)\)/g, G = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    (function () {
        function a(a, c, d) {
            var e = a.serializable, h = c[d ? "endContainer" : "startContainer"], n = d ? "endOffset" : "startOffset",
                ...
                renderHtml: function (a) {
                    ...
                    if (!this._.panel) {
                        var b = this._.panelDefinition,
                            d = this._.panelDefinition.block, i = b.parent || CKEDITOR.document.getBody(),
                            h = "cke_combopanel__" + this.name, e = new CKEDITOR.ui.floatPanel(a, i, b),
                            f = e.addListBlock(this.id, d), c = this;
                        e.onShow = function () {
        ...
        var j = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                setData: function (a, d) {
                    ...
                    var a =
                            this.editor, d = a.config, b = d.fullPage, c = b && a.docType, e = b && a.xmlDeclaration,
